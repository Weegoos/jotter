<template>
  <div>
    <q-card class="grid grid-cols-2" v-for="(friend, index) in pendingFriends" :key="index">
      <q-card-section>
      ...
      <q-card-actions align="right">
        <q-btn icon="mdi-thumb-up" color="primary" @click="acceptFriend(friend)" />
        <q-btn icon="mdi-thumb-down" color="red-4" @click="rejectFriend(friend)" />
      </q-card-actions>
    </q-card>
  </div>
</template>
